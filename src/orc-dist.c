/* autogenerated from GSTSIMPLESRCorc.orc */
...
#include <orc/orc.h>
#endif
void simple_src_orc_splat_u32 (guint8 * ORC_RESTRICT d1, int p1, int n);
...
/* simple_src_orc_splat_u32 */
#ifdef DISABLE_ORC
void
simple_src_orc_splat_u32 (guint8 * ORC_RESTRICT d1, int p1, int n)
{
  int i;
...
#else
static void
_backup_simple_src_orc_splat_u32 (OrcExecutor * ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
  orc_union32 *ORC_RESTRICT ptr0;
...
simple_src_orc_splat_u32 (guint8 * ORC_RESTRICT d1, int p1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      orc_program_set_backup_function (p, _backup_simple_src_orc_splat_u32);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "simple_src_orc_splat_u32");
      orc_program_set_backup_function (p, _backup_simple_src_orc_splat_u32);
