...
static void
simplesrc_setup_paintinfo (GSTSIMPLESRC * v, paintinfo * p, int w, int h)
{
  gint a, r, g, b;
  gint width;
...
static void
simplesrc_convert_tmpline (paintinfo * p, GstVideoFrame * frame, int j)
{
  int x = p->x_offset;
  int i;
...
#ifdef unused
static void
simplesrc_blend_color (struct vts_color_struct *dest,
...
static void
simplesrc_blend_line (GSTSIMPLESRC * v, guint8 * dest, guint8 * src,
...
void
gst_simple_src_smpte (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int i;
  int y1, y2;
  ...
  simplesrc_setup_paintinfo (v, p, w, h);
  ...
  for (j = 0; j < y1; j++) {
    ...
    simplesrc_convert_tmpline (p, frame, j);
  }
  ...
  for (j = y2; j < h; j++) {
...

    {
      ...
      simplesrc_blend_line (v, p->tmpline + x1 * 4, p->tmpline_u8 + x1,
...
void
gst_simple_src_smpte75 (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int i;
  int j;
...
void
gst_simple_src_smpte100 (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int i;
  int j;
...
void
gst_simple_src_bar (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int j;
  paintinfo pi = PAINT_INFO_INIT;
...
void
gst_simple_src_snow (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int i;
  int j;
  ...
  for (j = 0; j < h; j++) {
    ...
    simplesrc_blend_line (v, p->tmpline, p->tmpline_u8,
...
static void
gst_simple_src_unicolor (GSTSIMPLESRC * v, GstVideoFrame * frame,
    int color_index)
{
  int i;
  paintinfo pi = PAINT_INFO_INIT;
  ...
  for (i = 0; i < h; i++) {
    ...
    simplesrc_convert_tmpline (p, frame, i);
  }
}

void
gst_simple_src_black (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  gst_simple_src_unicolor (v, frame, COLOR_BLACK);
}

void
gst_simple_src_white (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  gst_simple_src_unicolor (v, frame, COLOR_WHITE);
}

void
gst_simple_src_red (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  gst_simple_src_unicolor (v, frame, COLOR_RED);
}

void
gst_simple_src_green (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  gst_simple_src_unicolor (v, frame, COLOR_GREEN);
}

void
gst_simple_src_blue (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  gst_simple_src_unicolor (v, frame, COLOR_BLUE);
}

void
gst_simple_src_blink (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int i;
  paintinfo pi = PAINT_INFO_INIT;
...
void
gst_simple_src_solid (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int i;
  paintinfo pi = PAINT_INFO_INIT;
...
void
gst_simple_src_checkers1 (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int x, y;
  paintinfo pi = PAINT_INFO_INIT;
  ...
  for (y = 0; y < h; y++) {
    ...
    simplesrc_convert_tmpline (p, frame, y);
  }
}

void
gst_simple_src_checkers2 (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int x, y;
  paintinfo pi = PAINT_INFO_INIT;
...
void
gst_simple_src_checkers4 (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int x, y;
  paintinfo pi = PAINT_INFO_INIT;
...
void
gst_simple_src_checkers8 (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int x, y;
  paintinfo pi = PAINT_INFO_INIT;
...
void
gst_simple_src_zoneplate (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int i;
  int j;
...
void
gst_simple_src_chromazoneplate (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int i;
  int j;
...
void
gst_simple_src_circular (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int i;
  int j;
...
void
gst_simple_src_gamut (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int x, y;
  paintinfo pi = PAINT_INFO_INIT;
...
void
gst_simple_src_ball (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int i;
  int radius = 20;
  ...
  if (v->motion_type == GST_simple_SRC_WAVY) {
  ...
  for (i = 0; i < h; i++) {
    ...
    if ((v->motion_type == GST_simple_SRC_SWEEP) ||
        (v->motion_type == GST_simple_SRC_HSWEEP)) {
  ...
  if ((v->motion_type == GST_simple_SRC_SWEEP) ||
    ...
    simplesrc_blend_line (v, p->tmpline, p->tmpline_u8,
        foreground_color, background_color, w);
    simplesrc_convert_tmpline (p, frame, h / 2);
    simplesrc_convert_tmpline (p, frame, y);
  }
}
...
paint_tmpline_ARGB (paintinfo * p, int x, int w)
{
  ...
  offset = (x * 4);
  simple_src_orc_splat_u32 (p->tmpline + offset, value, w);
}
...
void
gst_simple_src_pinwheel (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int i;
  int j;
...
void
gst_simple_src_spokes (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int i;
  int j;
...
void
gst_simple_src_gradient (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int i;
  int j;
...
void
gst_simple_src_colors (GSTSIMPLESRC * v, GstClockTime pts,
    GstVideoFrame * frame)
{
  int i;
  int j;
